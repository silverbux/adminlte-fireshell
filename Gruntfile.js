  ...
  grunt.initConfig({
    ...
    less: {
      dev: {
        ...
        files: {
          '<%= project.src %>/tmp/adminlte.css': 'src/less/AdminLTE.less'
        }
      }
    },
    ...
    watch: {
      ...
      sass: {
        ...
        tasks: ['sass:dev','autoprefixer:dev','cssmin:dev','concat:dev']
      },
      less: {
        files: '<%= project.src %>/less/{,*/}*.{less,less}',
        tasks: ['less:dev','autoprefixer:dev','cssmin:dev','concat:dev']
      },
      livereload: {
        options: {
